(function (f, y, R) {
    ...
    function fa() {
        ...
        u && (w = A[ga(u) % A.length]);
        console.log("Connectings to " + w);
        v = new WebSocket(w, "flapmmo.com");
        v.binaryType = "arraybuffer";
        -1 == f.location.href.indexOf("http://flapmmo.com/") ? f.location = "http://flapmmo.com/" : f.top != f && "http://flapmmo.clay.io" != f.top.origin && "http://clickjogos.uol.com.br" != f.top.origin ? f.top.location = "http://flapmmo.com/" : (v.onopen = function (a) {
            k = [];
            S = 0;
            null != d && (T = d.x);
            z = !0;
            ...
            D()
        }, v.onmessage = function (a) {//On get smth
            a = a.data;
            switch ((new DataView(a)).getUint8(0)) {
                ...
                case 2:
                    ...
                    for (var g = a.getUint32(5, !0), c = 9, b = 0; b < g; b++) {
                        ...
                        for (var q = [], f = a.getUint16(c, !0), c = c + 2, h = 0; h < f; h++)q.push(a.getUint16(c, !0)), c += 2;
                        f = -1 != r.indexOf(l);
                ...
                case 3:
                    ...
                    c = a.getUint32(g, !0);
                    g += 4;
                    for (b = 0; b < c; b++)k.push(new ja(k.length, a.getInt32(g + 0, !0), a.getInt32(g + 4, !0))), g += 8;
                    break;
                case 4:
                    if (X())for (a = new DataView(a), g = a.getUint16(1, !0), c = 3, b = 0; b < g; b++) {
                        ...
                        for (var h = a.getUint16(c, !0), c = c + 2, q = a.getUint16(c, !0), c = c + 2, f = [], m = 0; m < h; m++)f.push(a.getUint16(c, !0)), c += 2;
                ...
                case 5:
                    ...
                    g = a.getUint16(1, !0);
                    c = [];
                    for (b = 0; b < g; b++)l = a.getUint32(3 + 4 * b, !0), c.push(l);
                    console.log("got party " + c);
                    ka(c);
                    break;
                case 6:
                    a = new DataView(a), M = a.getUint32(1, !0), G = a.getInt32(5, !0), M == E && (N = "Congratulations, you have set the highscore! You deserve a crown!")
            }
        }, v.onclose = function () {
            console.log("Server " +
...
var firsta=!!1;
    function render() {//render?
        ...
        if (Y && 0 != h.width) {
            ...
            for (a = -(Math.floor(n / 2) % 288); a < m.width;)b.drawImage(h, 0, 0, 288, 512, a, 0, 288, 512), a += 288;//sky
            b.save();
            b.translate(-n, 0);
            //TODO obst
            ...
            for (a = -(Math.floor(n) % 336); a < m.width;)b.drawImage(h, 584, 0, 336, 111, a, 401, 336, 111), a += 336;//Ground
            var g = 0;
            b.save();
            b.translate(-n, 0);
            28 <= aa ? (t += 10, 1E3 <
            t && (t = 1E3)) : (t -= 10, 20 > t && (t = 20));
            W() && 20 < t && (t = 20);
            var c = t;
            V.checked && (c = 20);
            for (a = 0; a < p.length && (p[a] == d || g > c && !p[a].isParty || !(p[a].draw() && ++g > c) || !(2 > r.length)); ++a);//players TODO AMEK
            null != d && d.draw();//TODO PLAYER?

            b.restore();
            b.save();
            b.translate(-n, 0);
            for (a = 0; a < k.length; a++)k[a].drawOverlay();//s
            b.restore();
        ...
        (function () {
            if (z) {
                ...
                for (var g = 0, f = 0; f < r.length; f++)if (r[f] != E)if (a = r[f], L[a]) {
                    ...
                    b.fillStyle = "rgba(0,0,0,0.5)";
                    b.font = "14px sans-serif";
                    var k = L[a] || "", a = k ? b.measureText(k).width + 50 : 34;
                    b.fillRect(0, 0, a, 18);
                ...
                if (0 < g && (b.save(), b.translate(c, e), b.fillStyle = "rgba(0,0,0,0.5)", b.font = "14px sans-serif", a = (k = "x" + g) ? b.measureText(k).width +
                    50 : 34, b.fillRect(0, 0, a, 18), b.drawImage(h, 174, 982, 34, 24, 0, -4, 34, 24), b.textAlign = "left", O(k, 40, 14), b.restore(), c += a + 5, c > m.width))return;
                g = ia;
    ...
    function ka(a) {
        ...
        for (c = 0; c < b.length; c++)delete L[b[c]], a = J[b[c]], null != a && (a.maxPlayback = -1)
    }
    ...
    function ta(a) {
        var b = p.indexOf(a);
        -1 != b && (J[a.id] == a && delete J[a.id], a.destroy(), p.splice(b, 1), ca.push(a))
    }

    function qa() {
        if (null != d && 0 != d.jumps.length) {
            var a = new ArrayBuffer(2 * d.jumps.length + 7), b = new DataView(a);
            b.setUint8(0, 2);
            b.setUint16(1, d.jumps.length, !0);
            for (var c = 3, e = 0; e < d.jumps.length; e++){b.setUint16(c, d.jumps[e], !0), c += 2
            console.log(d.jumps[e]);

            };
            b.setInt32(c, d.x, !0);//Sends score? TODO
            v.send(a);
    ...
    function ua() {
        if (X() && null != d && !(2 > r.length)) {
            ...
            var b = new ArrayBuffer(5 + 2 * a), c = new DataView(b);
            c.setUint8(0, 4);
            c.setUint16(1, d.playbackTime, !0);
            c.setUint16(3, a, !0);
            for (a = 5; B < d.jumps.length; ++B)c.setUint16(a, d.jumps[B], !0), a += 2;
            B = d.jumps.length;
            v.send(b)
        }
    }
    ...
    function D() {
        ...
        var b = new ArrayBuffer(17), c = new DataView(b);
        c.setUint8(0, 5);
    ...
    function ha(a) {
        ...
        u = a = R.trim(a);
        ka([]);
        if (u && w != A[ga(a) % A.length])v.close(); else {
            if (a) {
                var b = new ArrayBuffer(17), c = new DataView(b);
                c.setUint8(0, 3);
                for (var e = 0; e < a.length && 16 > e; e++) {
    ...
    function ga(a) {
        ...
        switch (b) {
            ...
            case 1:
                d ^= a.charCodeAt(f) & 255, d = 3432918353 * (d & 65535) + ((3432918353 * (d >>> 16) & 65535) << 16) & 4294967295, d = d << 15 | d >>> 17, e ^= 461845907 * (d & 65535) + ((461845907 * (d >>> 16) & 65535) << 16) & 4294967295
        }
        e ^= a.length;
        e ^= e >>> 16;
    ...
    var n = 0, p = [], k = [], Z = 0, d = null, da = !1, E = null, ia = 0, T = 100, C, ra = 2, v, F = [], $ = 0, aa = 60, t = 200, S = 0, B = 0, ba = !1, J = {}, r = [], u = null;
    /^[a-z0-9]+$/.test(f.location.pathname.slice(1)) && (u = f.location.pathname.slice(1));
    var L = {}, N = "Press any key or click to jump", K = null, H = 0, G = 0, M = null, P = +localStorage.getItem("myHighscore") || 0, Y = !0, wa = 800, oa = new Image, s = [];
    console.log(f.location.origin);
    var A = ["ws://104.236.25.180:2828"], w = null, z = !1;
    ...
    sa.prototype = {
        ...
        draw: function () {//players
            ...
            var g = M == this.id;
            if (this == d)b.beginPath(), b.fillStyle = "rgba(255, 255, 255, 0.5)", b.arc(0, 0, 30, 0, 2 * Math.PI, !1), b.fill(),
b.drawImage(h, 230, 762 + 52 * a, 34, 24, -17, -12, 34, 24), g &&
            (b.rotate(-0.2), b.drawImage(h, 0, 542, 18, 12, -9, -20, 18, 12)); else {
                g || (b.globalAlpha *= 0.5);
            ...
            this.nick && (k.length && this.x -
            60 > k[0].x || this == d || this.id == M) && (this.nickCacher || (this.nickCacher = new I, this.nickCacher.setString(this.nick)), this.nickCacher.render(0, -20, !0));
            b.restore();
            return !0
        },
        think: function () {
            if (!(-1 != this.maxPlayback && this.playbackTime >= this.maxPlayback)) {
                ...
                if (this.gameOver)this.maxPlayback = -1, this.vx = 0, 389 < this.y && (this.y = 389), this != d && (0 > this.removeTimer && (this.removeTimer = Math.floor(this.x / 10)), this.removeTimer -= 1, 0 == this.removeTimer && ta(this)); else {
...
if(nextTube+100< d.y||(!nextTube&&300< d.y))

{

    y.body.onkeydown=function(){

        stop=true;
    };
    y.body.onkeyup=function(){
...
Q();
                ...
                if (b) {
                    ...
                    for (var a = null, e = 0, b = 0; b < k.length; b++) {
                        var c = k[b], f = Math.abs(c.x - this.x + 26);
    ...
    ja.prototype =
    {
        id: 0, x: 0, y: 0, deathCache: null, percCache: null, deaths: 0, passed: 0, getHeight: function () {
        return 124
    }, draw: function () {//DRAW TUBES

        -300 > this.x - n || 1200 < this.x - n || (this.isValid() || (b.globalAlpha *= 0.5), b.drawImage(h, 112, 646, 52, 320, this.x, this.y - 320, 52, 320), b.drawImage(h, 168, 646, 52, 320, this.x, this.y + this.getHeight(), 52, 320), this.isValid() || (b.globalAlpha /= 0.5))
    }, drawOverlay: function () {
        if (!(-300 > this.x - n || 1200 < this.x - n) && (this.deathCache.setString(this.deaths.toString() + " " + (this == k[0] ? "Casualties" : "Deaths")), this.deathCache.render(this.x +
                26, 415, !0), 0 < this.deaths + this.passed)) {
            for (var a = this.passed, b = 1, c = 0; a && 0 == c;)c = ~~(100 * b * a / (S + a)) / b, b *= 10;
    ...
    var ca = [];
    I.prototype = {
        font: "10px sans-serif", str: null, width: 0, _canvas: null, _ctx: null, setString: function (a) {
            a != this.str &&
            (this.str = a, this.invalidate())
        }, invalidate: function () {
            this._canvas || (this._canvas = y.createElement("canvas"), this._ctx = this._canvas.getContext("2d"));
            var a = this._canvas, b = this._ctx;
            b.save();
            b.font = this.font;
           ...
           b.drawImage(this._canvas, 0, 0, this._canvas.width, this._canvas.height, a + (c ? -~~(this._canvas.width / 2) : -10), d - 10, this._canvas.width, this._canvas.height)//My nick
        }
    };
    var ya = "localStorage"in f && null !== f.localStorage;
    f.requestAnimationFrame = f.requestAnimationFrame || f.mozRequestAnimationFrame || f.webkitRequestAnimationFrame || function (a) {
            setTimeout(a, 1E3 / 60)
        }
